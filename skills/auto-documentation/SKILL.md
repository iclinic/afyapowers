...
1. **Afyapowers artifacts** — If `.afyapowers/<feature>/artifacts/` exists, read `brainstorm.md`, `tech-spec.md`, `plan.md`, and `review.md` for rich context about requirements, architecture, and decisions. These are optional but produce significantly better docs.
