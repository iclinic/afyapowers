---
name: implementing
description: "Use when the current afyapowers phase is implement — executes plan tasks with subagents and two-stage review"
---
...
digraph process {
    ...
    "Code quality reviewer subagent approves?" -> "Mark task complete in plan" [label="yes"];
    "Mark task complete in plan" -> "More tasks remain?";
    "More tasks remain?" -> "Dispatch implementer subagent (./implementer-prompt.md)" [label="yes"];
    "More tasks remain?" -> "Suggest /afyapowers:next" [label="no"];
}
```
