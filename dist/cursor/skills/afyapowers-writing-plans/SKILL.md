...
- Read `.afyapowers/features/<feature>/artifacts/project-context.md` if it exists — this contains all project conventions captured during the design phase. When this file exists, DO NOT explore the codebase for patterns or conventions — use this artifact exclusively for file naming, structure, code patterns, testing patterns, import conventions, and commit conventions
...
5. Read `.afyapowers/features/<feature>/artifacts/project-context.md` if it exists — this contains all project conventions captured during the design phase. When this file exists, DO NOT explore the codebase for patterns or conventions — use this artifact exclusively for file naming, structure, code patterns, testing patterns, import conventions, and commit conventions
...
- In existing codebases: if `project-context.md` exists, follow its documented patterns exclusively — do not explore the codebase for conventions. If no `project-context.md` exists, explore the codebase to understand patterns before defining files. If the codebase uses large files, don't unilaterally restructure - but if a file you're modifying has grown unwieldy, including a split in the plan is reasonable.
