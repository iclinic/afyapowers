...
| Requirements challenged | Every Figma annotation and JIRA acceptance criterion must be reflected **and confirmed** in the design — not transcribed verbatim without analysis. Look for inputs copied straight in with no states/rules worked out around them. |
