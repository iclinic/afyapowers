...
**REQUIRED:** Invoke `afyapowers:figma-component` via the Skill tool to handle the entire process. Pass along any Figma URL or component reference the user has already provided.
