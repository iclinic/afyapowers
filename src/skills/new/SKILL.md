...
Then invoke `{{skill:design}}` via the Skill tool to begin the design phase. It will guide the conversation to clarify requirements, explore approaches, define architecture, and reach alignment.
