...
- **The design phase** (`{{skill:design}}`) — entry points are the `### Componentes` entries (`C1`, `C2`…) produced by the @"figma-reader (agent)" subagent. Output goes back into those entries and into `design.md`.
